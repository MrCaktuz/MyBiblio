              ...
              <div class="panel-body">
                  <ol class="list-group">
                      <?php foreach ( $datas[ 'lastBooks' ] as $book ) :?>
                              <li class="list-group-item"><a href="index.php?a=show&e=books&id=<?php echo $book -> id; ?>"><?php echo $book -> title; ?></a></li> <!--tous les liens pointe vers le index.-->
                      <?php endforeach; ?>

                      <li class="list-group-item"><a class="btn btn-primary" href="?a=index&r=books">See more ...</a></li>
                  </ol>
              </div>
            </div>
        </div>
              ...
              <div class="panel-body">
                  <ol class="list-group">
                      <?php foreach ( $datas[ 'lastAuthors' ] as $author ) :?>
                              <li class="list-group-item"><a href="index.php?a=show&e=authors&id=<?php echo $author -> id; ?>"><?php echo $author -> name; ?></a></li> <!--tous les liens pointe vers le index.-->
                      <?php endforeach; ?>
